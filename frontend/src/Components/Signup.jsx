...
function Signup() {
  //---------------sign hote hi home pe redirect karane ke liye use kiya
  ...
  const onSubmit = async(data) => {
   ...
   await axios.post("https://abhibooks-backend.onrender.com/user/signup",userInfo)
    .then((res)=>{
      ...
      localStorage.setItem("User",JSON.stringify(res.data.milgya));
    })
    .catch((err)=>{
      if (err.response) {
        console.log(err);
  ...
  return (
    <>
     ...
     <div className="flex md:mt-[-130px] h-screen items-center justify-center">
